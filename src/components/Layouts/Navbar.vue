                ...
                <div class="container-fluid">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        ...
                        <div class="others-options d-flex align-items-center">
                            ...
                            <div class="option-item">
                                <div @click="search = !search" :aria-pressed="search ? 'true' : 'false'"
                            ...
                            <div class="option-item">
                                <div class="side-menu-btn" v-on:click="isSideMenuMethod(isSideMenu)">
        ...
        <div class="sidebarModal modal right" v-if="isSideMenu">
            <div class="modal-dialog">
                <div class="modal-content">
                    <button type="button" class="close" v-on:click="isSideMenuMethod(isSideMenu)">
                        <i class="ri-close-line"></i>
                    </button>
                    ...
                    <div class="modal-body">
                        ...
                        <ul class="sidebar-social-list">
                            <li><a href="https://facebook.com/" target="_blank"><i class="ri-facebook-fill"></i></a>
                            </li>
                            <li><a href="https://twitter.com/" target="_blank"><i class="ri-twitter-fill"></i></a></li>
                            <li><a href="https://linkedin.com/" target="_blank"><i class="ri-linkedin-fill"></i></a>
                            </li>
                            <li><a href="https://instagram.com/" target="_blank"><i class="ri-instagram-fill"></i></a>
                            </li>
                        </ul>
